...
module.exports = {
    ...
    theme: {
        ...
        colors: {
            ...
            'action-disable': 'var(--color-action-disable)',
            'action-disable-background': 'var(--color-action-disable-background)',
            'bg-primary': 'var(--color-bg-primary)',
            'bg-secondary': 'var(--color-bg-secondary)',
            'text-primary': 'var(--color-text-primary)',
            'text-secondary': 'var(--color-text-secondary)',
            'text-emotion': 'var(--color-text-emotion)',
            'text-disable': 'var(--color-text-disabled)',
        ...
        boxShadow: {
            ...
            inverse: '0 -1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)',
            around: '0 0px 15px 0px rgba(0, 0, 0, 0.25)',
    ...
    variants: {
        ...
        backgroundColor: ['responsive', 'dark', 'disabled', 'group-hover', 'focus-within', 'hover', 'focus'],
